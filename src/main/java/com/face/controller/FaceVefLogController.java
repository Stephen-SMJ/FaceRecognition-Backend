...
public class FaceVefLogController {
    ...
    {
        QueryWrapper<FaceVefLog> faceVefLogQueryWrapper = new QueryWrapper<>();
        faceVefLogQueryWrapper
        ...
        IPage<FaceVefLog> page = faceVefLogService.page(new Page<>(current,size),faceVefLogQueryWrapper);
